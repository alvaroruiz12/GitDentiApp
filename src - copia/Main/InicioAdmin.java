...
//	private JTable table;
	...
	public InicioAdmin(ArrayList<String> a, Conexion con) {
		...
		mntmNewMenuItem_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				boolean modal3 = true;
				ConsultarCitas cc = new ConsultarCitas(a, con, padre, modal3);
				cc.setVisible(true);
			}
		});
		...
		JMenuItem mntmNewMenuItem_10 = new JMenuItem("Añadir prooveedores");
		...
		JMenuItem mntmNewMenuItem_2 = new JMenuItem("Modificar proveedores");
		...
		JMenuItem mntmNewMenuItem_3 = new JMenuItem("Consultar proveedores");
		...
		JMenuItem mntmNewMenuItem_12 = new JMenuItem("Dar de baja proveedor");
		...
		JMenuItem mntmNewMenuItem_13 = new JMenuItem("Dar de alta una especialidad");
		...
		JMenuItem mntmNewMenuItem_14 = new JMenuItem("Modificar una especialidad");
		...
		JMenuItem mntmNewMenuItem_15 = new JMenuItem("Consultar una especialidad");
		...
		JMenuItem mntmNewMenuItem_16 = new JMenuItem("Eliminar una especialidad");
